...
namespace YooAsset
{
	internal class CacheManager
	{
		internal class RecordWrapper
		{
			...
			public string DataFileHash { private set; get; }
			public long DataFileSize { private set; get; }

			public RecordWrapper(string infoFilePath, string dataFilePath, string dataFileCRC,string dataFileHash, long dataFileSize)
			{
